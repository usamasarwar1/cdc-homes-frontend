...
export default function CredentialComparisonPage() {
  ...
  const handleCredentialChange = (credentialValue, checked) => {
    if (checked) {
      ...
      setSelectedCredentials((prev) =>
        prev.filter((c) => c !== credentialValue),
      );
    }
  };
  ...
  const handleSubmit = () => {
    ...
    localStorage.setItem(
      "challengeAvailable",
      JSON.stringify(challengeAvailable),
    );
  ...
  const handleFinalSubmit = async () => {
    try {
      ...
      if (!emailRegex.test(payerEmail)) {
        setEmailError(
          "Please enter a valid email address etc 'example@gmail.com",
        );
        setIsLoading(false);
        return;
      }
      ...
      toast({
        title: "Thank you!",
        description:
          "We will verify the provided information within 2 hours. If the credentials are confirmed, we will honor the discounted price.",
      });
      navigate("/");
    } catch (error) {
      ...
      toast({
        title: "Error",
        description: `Error: ${error.message || "Failed to save booking. Please try again."}`,
      });
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="max-w-7xl mx-auto px-2 md:px-4 py-4 md:py-8">
        <div className="text-center mb-6 md:mb-8 px-2">
          <h1 className="text-xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8 leading-tight">
            Who Would You Trust to Protect Your Family, Your Investment and Your
            Peace of Mind?
          </h1>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 max-w-4xl mx-auto mb-6">
            <div className="flex items-center justify-center mb-2">
              ...
              <h3 className="text-lg font-semibold text-blue-900">
                Compare Credentials Challenge
              </h3>
            </div>
            <p className="text-blue-800 text-sm md:text-base text-center">
              Select the credentials that match your current inspector below. If
              you can find someone with the same qualifications as CDC Home
              Inspections, we'll honor a special discount. We're confident you
              won't find a match!
            </p>
          </div>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-blue-600 text-white">
                  <th className="text-left p-2 md:p-4 font-semibold text-sm md:text-base">
                    Credential
                  </th>
                  <th className="text-center p-2 md:p-4 font-semibold text-sm md:text-base min-w-[100px] md:min-w-[200px]">
                    Our Competitor
                  </th>
                  <th className="text-center p-2 md:p-4 font-semibold text-sm md:text-base min-w-[100px] md:min-w-[200px]">
              ...
              <tbody>
                {inspectorCredentials.map((credential, index) => {
                  const isSelected = selectedCredentials.includes(
                    credential.value === "dual_kb2_license"
                      ? "dual_kb_license"
                      : credential.value,
                  );
                  ...
                  return (
                    <tr
                      ...
                      className={`${index % 2 === 0 ? "bg-gray-50" : "bg-white"} ${rowOpacity}`}
                    >
                      <td
                        className={`p-2 md:p-4 font-medium text-sm md:text-base ${isDisabled ? "text-gray-400" : "text-gray-900"}`}
                      >
                        {credential.label}
                      </td>
          ...
          <div id="results-section" className="mt-6 space-y-6">
            ...
            <div className="p-6 bg-red-50 border-2 border-red-300 rounded-lg">
              <div className="text-center text-red-800">
                ...
                <div className="font-semibold mb-2">
                  The inspector you selected is rated with a {matches}/{total}{" "}
                  match ({matchPercentage}%) which does not qualify for 50% Off.
                </div>
                <div className="text-sm">
                  Only {matches} out of {total} qualifications matched — that's{" "}
                  {matchPercentage}%. Trust your home inspection to a more
                  qualified professional with key expertise.
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border-2 border-gray-300 rounded-lg p-6 shadow-lg">
              ...
              <p className="text-center text-gray-600 mb-6">
                Since credentials don't fully match, regular pricing is in
                effect
              </p>
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    const urlParams = new URLSearchParams({
                      ...
                      squareFootage:
                        propertyData.squareFootage?.toString() || "",
                ...
                >
                  ...
                  >
                    {matches === 9 && total === 9
                      ...
                      : "Not Available - Incomplete Match"}
                  </div>
                  <div
              ...
              <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-center text-yellow-800 text-sm font-medium">
                  💡 Want the 50% discount? Find an inspector with all 9
        ...
        {showDetailForm && (
          <div id="results-section" className="mt-6 space-y-6">
            ...
            <div className="p-6 bg-green-50 border border-green-200 rounded-lg mb-6">
              <div className="text-center text-green-800 mb-4">
                ...
                <div className="text-sm mb-4">
                  Please provide the inspector's license details for
                  verification:
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("licenseNumbers", e.target.value)
                    }
            ...
            {whoIsPaying && (
              <div className="p-6 bg-blue-50 border border-blue-200 rounded-lg mb-6">
                <div className="text-center text-blue-800 mb-4">
                  ...
                  <div className="text-sm mb-4">
                    Please provide the Email details for a Payer which one is
                    paying:
                  </div>
                </div>
            ...
            <div
              ...
              style={{ animation: "dramatic-pulse 1.2s ease-in-out infinite" }}
            >
              ...
              <div className="grid grid-cols-1 gap-4">
                <div
                  className="p-4 border border-green-200 rounded-lg text-center bg-green-50"
                  style={{
                ...
                >
                  ...
                  <div className="text-2xl font-bold text-green-800">
                    ${Number(price.challengePrice).toFixed(2)}
                  </div>
                  <div className="text-sm text-gray-600">
                    50% Off Standard Rate (${price.basePrice})
                  </div>
                </div>
              </div>
