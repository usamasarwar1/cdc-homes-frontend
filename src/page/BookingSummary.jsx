...
export default function BookingSummary() {
  ...
  const calculatePrice = () => {
    ...
    if (bookingData.propertyType === "Multi-Family Residence") {
      ...
      if (
        selectedPaymentMethod === "challenge" &&
        booking &&
        booking.property?.challengePrice
      ) {
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <div className="text-xs text-green-700 bg-white/30 p-2 rounded mt-2">
            <strong>Almost done!</strong> Review all details below, then select
            your preferred inspection date and time
          </div>
        </GuidanceCard>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Review your inspection details before scheduling
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="bg-white">
              ...
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium">
                      {bookingData.payeeName.firstName}{" "}
                      {bookingData.payeeName.lastName}
                    </p>
                    <p className="text-sm text-gray-600 capitalize">
                      {bookingData.relationshipToBuyer}
                      {bookingData.buyerExplanation &&
                        ` - ${bookingData.buyerExplanation}`}
                    </p>
                  </div>
                    ...
                    {bookingData.reportEmail && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">
                          Report: {bookingData.reportEmail}
                        </span>
                      </div>
                    )}
                  </div>
                ...
                {bookingData.contactPersons &&
                  bookingData.contactPersons.length > 0 && (
                    <>
                      <Separator />
                      <div>
                ...
                {bookingData.wantsRealtorNotification &&
                  bookingData.realtorName && (
                    <>
                      <Separator />
                      <div>
                        <p className="text-sm text-gray-600 mb-2">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium">
                      ${Number(pricing.basePrice).toFixed(2)}
                    </span>
                  </div>
