...
const PropertyDetails = () => {
  ...
  const getCustomerEmail = (booking) => {
    return (
      booking.verifiedContact?.payerEmail ||
  ...
  const getBooking = async () => {
    try {
      ...
      const combinedBooking = {
        ...
        ...(bookingData.verifiedContact && {
          verifiedContact: bookingData.verifiedContact,
        }),
  ...
  const handleApprove = async (bookingId) => {
    ...
    try {
      ...
      const response = await fetch(
        `${VITE_BASE_URL}/propertyVerificationApproval`,
        {
          method: "POST",
          headers: {
  ...
  const handleReject = async (bookingId) => {
    ...
    try {
      ...
      const VITE_BASE_URL = import.meta.env.VITE_BASE_URL;
      const response = await fetch(
        `${VITE_BASE_URL}/rejectPropertyVerification`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleAdditionInfo = async () => {
    ...
    try {
      ...
      for (const contact of booking.additionalContact) {
        const response = await fetch(
          `${VITE_BASE_URL}/additionalAcknowledgementReport`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
      ...
      toast({
        title: "Acknowledgement Message Sent",
        description:
          "The acknowledgement message has been sent to the additional contacts.",
      });
    } catch (error) {
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">
                    {booking.property?.squareFootage?.toLocaleString() || "N/A"}{" "}
                    ft²
                  </p>
                </div>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <p className="font-semibold text-yellow-900">
                        Challenge Payment (50% Discount)
                      </p>
                    </div>
                    <p className="text-sm text-yellow-800">
                      This booking is using the challenge payment method and
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {!booking.isDiscount && (
                      <div className="bg-gray-50 rounded-lg p-4">
                        ...
                        <p className="text-2xl font-bold text-gray-900">
                          $
                          {booking.property?.basePrice?.toLocaleString() ||
                            "N/A"}
                        </p>
                      </div>
                    )}
                    <div className="bg-blue-50 rounded-lg p-4">
                      ...
                      <p className="text-2xl font-bold text-blue-700">
                        $
                        {booking.property?.challengePrice?.toLocaleString() ||
                          "N/A"}
                      </p>
                    </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium text-gray-900">
                      {`${booking.inspector.firstName} ${booking.inspector.lastName}` ||
                        "N/A"}
                    </p>
                  </div>
                  <div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 text-lg">
                      {formatDateTime(booking.formattedDateTime) ||
          ...
          {!isDiscount && booking.verifiedContact && (
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {booking.verifiedContact.wantsRealtorNotification &&
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Badge
                  variant={
                    isDiscount || booking.property.isDiscount
                      ? "outline"
                      : "default"
                  }
                  className={
              ...
              <CardContent>
                ...
                <div className="space-y-2">
                  ...
                  <Button
                    ...
                    variant="destructive"
                    className="w-full text-white bg-[#dc2626] hover:bg-[#dc2626]/90"
                  >
                    {loading ? (
                      <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                    ) : (
