    ...
    try {
      ...
      if (data.success && data.property) {
        setPropertyData({
          ...
          zipCode:
            data.property.zipCode || extractZipCode(suggestion.description),
          isValidated: true,
        });
      } else {
        setShowAddressNotFound(true);
    ...
    <div className="relative">
      <div className="relative bg-white rounded-xl shadow-lg border-2 border-stone-200 p-4 md:p-6">
        <div className="text-center mb-4 md:mb-6">
          ...
          <p className="text-sm md:text-base text-gray-600 px-2">
            Please enter the Submit Button below to begin your inspection
            booking
          </p>
        </div>
      ...
      <Dialog
        open={isOpen}
        onOpenChange={hanldeCloseModal}
        height="h-[calc(100vh-200px)]"
      >
        {/* <DialogContent className="max-w-[250px] md:max-w-xl  rounded-lg  bg-white shadow-sm border-2 border-stone-200"> */}
        <DialogContent
          className="
  w-[95vw] 
  max-w-[95vw] 
        ...
        >
            ...
            <div className="space-y-6">
              <div className="relative">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 text-base md:text-lg py-3 md:py-2 w-full border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                ...
                {showSuggestions && suggestions.length > 0 && (
                  <div className="absolute top-full left-0 right-0 bg-white border border-gray-200 rounded-lg shadow-lg max-h-56 md:max-h-60 text-base md:text-base overflow-y-auto z-50 mt-1">
                    {suggestions.map((suggestion, index) => (
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <span className="text-sm md:text-base text-gray-900 leading-tight">
              ...
              {showAddressNotFound && !isLoadingSuggestions && (
                <div className="text-center py-3 md:py-4 border border-amber-200 rounded-lg bg-amber-50">
                  ...
                  <p className="text-sm md:text-base text-amber-700 mb-3 px-2">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (
                        value === "" ||
                        (parseInt(value) >= 1 && parseInt(value) <= 999999)
                      ) {
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    if (
                      value === "" ||
                      (parseInt(value) >= 1 && parseInt(value) <= 6000)
                    ) {
          ...
          {propertyData && (
            <div className="mt-4 md:mt-6 p-3 md:p-4 border border-green-200 rounded-lg bg-green-50">
              ...
              <div className="flex flex-col md:flex-row items-start md:space-x-3 space-y-3 md:space-y-0">
                <CheckCircle className="h-5 w-5 md:h-6 md:w-6 text-green-600 flex-shrink-0 mt-0.5" />
                <div className="flex-1">
                  <h3 className="text-sm md:text-base font-medium text-green-900 mb-2">
                        ...
                        onChange={(e) => {
                          ...
                          if (
                            ...
                            setPropertyData((prev) =>
                              prev
                                ? { ...prev, squareFootage: parseInt(value) }
                                : null,
                            );
                          }
                        }}
                  ...
                  <div className="mt-3 md:mt-4">
                    <label className="flex items-center space-x-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setSquareFootageConfirmed(e.target.checked)
                        }
                        className="rounded border-gray-300 text-green-600 focus:ring-green-500"
                      />
                      <span className="text-xs md:text-sm text-gray-700">
